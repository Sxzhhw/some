...
"""
#简单来说datasset会返回一个张量是问题和文本的id组成

#具体步骤

#把问题【1，2，3】----》【1，2，3；/n 1，2，3】和文本【2，4，5，7，7】

#---填充---》【2，4，5，7，7，7】---》【2，4，5；/n 7，7，7】
import datetime
import json
import math
...
class ChunkTokenizer:
    ...
    def __call__(
        ...
        """
#prefix_tokens 得到pytorch张量（由token_id转化）如tensor([[8, 53, 24, 4, 19, 5, 3, 2, 9, 10]])
#chunk_size=1024
        if query:
            prefix = f"<s>{query}</s>"
        else:
